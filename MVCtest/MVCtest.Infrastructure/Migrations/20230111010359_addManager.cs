        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Marks record as deleted")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedTime", "DisplayOrder", "Name" },
                values: new object[] { 1, new DateTime(2023, 1, 11, 1, 3, 59, 163, DateTimeKind.Local).AddTicks(9921), "Retro", "One" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedTime", "DisplayOrder", "Name" },
                values: new object[] { 2, new DateTime(2023, 1, 11, 1, 3, 59, 163, DateTimeKind.Local).AddTicks(9932), "Onicks", "Two" });

            migrationBuilder.InsertData(
                table: "Covers",
                columns: new[] { "Id", "Name", "isDeleted" },
                values: new object[] { 1, "One", false });
